...
<head>
    ...
    <style>
        *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .models-pill[data-tooltip]:hover::after { content: attr(data-tooltip); white-space: pre; position: absolute; bottom: calc(100% + 4px); left: 0; background: #334155; color: #f1f5f9; padding: 6px 10px; border-radius: 6px; font-size: 0.78rem; line-height: 1.5; z-index: 1000; pointer-events: none; box-shadow: 0 2px 8px rgba(0,0,0,0.3); border: 1px solid #475569; min-width: 140px; }
        [data-theme="dark"] .models-pill[data-tooltip]:hover::after { background: #1e293b; border-color: #334155; }
                    ...
                    if (workersList.length === 0) {
                        ...
                        wlEl.innerHTML = workersList.map(function(w) {
                            ...
                            return '<div class="worker-card">' +
                                ...
                                '<span class="wm-item models-pill" data-tooltip="'+escapeHtml(modelTitles)+'">\uD83E\uDDE9 '+modelCount+' model'+(modelCount!==1?'s':'')+(modelCount>0?' \u25BE':'')+'</span>' +
                                '</div>' +
